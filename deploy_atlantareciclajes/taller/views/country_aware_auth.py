...
class CountryAwareLoginView(LoginView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if country_param:
            ...
            print(f"[CountryAwareLoginView.dispatch] GET param detected - Country: {country}, Language: {lang_full}, Activated: {get_language()}")
        else:
        ...
        if hasattr(request, 'session'):
            print(f"[CountryAwareLoginView.dispatch] Session preferred_country: {request.session.get('preferred_country', 'N/A')}")
            print(f"[CountryAwareLoginView.dispatch] Session django_language: {request.session.get('django_language', 'N/A')}")
        ...
        print(f"[CountryAwareLoginView.dispatch] request.LANGUAGE_CODE: {getattr(request, 'LANGUAGE_CODE', 'NOT SET')}")
    ...
    def get_template_names(self):
        ...
        if country_param:
            ...
            print(f"[get_template_names] GET param detected - Country: {country}, Language: {lang_full}, Activated: {get_language()}")
        ...
        print(f"[get_template_names] self.template_name set to: {self.template_name} (type: {type(self.template_name)})")
        return candidates
    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        if country_param:
            ...
            self.request.session["preferred_country"] = country
            self.request.session["django_language"] = lang_full
            print(f"[render_to_response] Forced country: {country}, language: {lang_full} from GET param")
...
def country_aware_login(request, *args, **kwargs):
    ...
    print(f"[country_aware_login] Cookie django_language: {request.COOKIES.get('django_language', 'NOT SET')}")
    ...
    if country_param:
        ...
        print(f"[country_aware_login] GET param detected - Country: {country}, Language: {lang_full}")
        ...
        print(f"[country_aware_login] No country param, using request.country: {getattr(request, 'country', 'N/A')}")
