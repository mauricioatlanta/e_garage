...
try:
    ...
    print(f"✅ Repuesto: {linea_rep.nombre} - Cantidad: {linea_rep.cantidad} - Precio: ${linea_rep.precio_unitario}")
    ...
    print(f"✅ Servicio: {linea_serv.nombre} - Cantidad: {linea_serv.cantidad} - Precio: ${linea_serv.precio_unitario}")
    ...
    print(f"\n✅ VERIFICACIÓN:")
    print(f"   Repuestos esperados: ${expected_repuestos} - Actual: ${doc_cl.total_repuestos} - {'✅' if doc_cl.total_repuestos == expected_repuestos else '❌'}")
    print(f"   Servicios esperados: ${expected_servicios} - Actual: ${doc_cl.total_servicios} - {'✅' if doc_cl.total_servicios == expected_servicios else '❌'}")
    print(f"   Otros esperados: ${expected_otros} - Actual: ${doc_cl.total_otros} - {'✅' if doc_cl.total_otros == expected_otros else '❌'}")
    print(f"   IVA esperado: ${expected_iva} - Actual: ${doc_cl.iva} - {'✅' if doc_cl.iva == expected_iva else '❌'}")
    print(f"   Total esperado: ${expected_total} - Actual: ${doc_cl.total_general} - {'✅' if doc_cl.total_general == expected_total else '❌'}")
...
try:
    ...
    print(f"✅ Repuesto: {linea_rep_us.nombre} - Cantidad: {linea_rep_us.cantidad} - Precio: ${linea_rep_us.precio_unitario}")
    ...
    print(f"✅ Servicio: {linea_serv_us.nombre} - Cantidad: {linea_serv_us.cantidad} - Precio: ${linea_serv_us.precio_unitario}")
    ...
    print(f"\n✅ VERIFICACIÓN:")
    print(f"   Repuestos esperados: ${expected_repuestos_us} - Actual: ${doc_us.total_repuestos} - {'✅' if doc_us.total_repuestos == expected_repuestos_us else '❌'}")
    print(f"   Servicios esperados: ${expected_servicios_us} - Actual: ${doc_us.total_servicios} - {'✅' if doc_us.total_servicios == expected_servicios_us else '❌'}")
    print(f"   Otros esperados: ${expected_otros_us} - Actual: ${doc_us.total_otros} - {'✅' if doc_us.total_otros == expected_otros_us else '❌'}")
    print(f"   Sales Tax esperado: ${expected_iva_us} - Actual: ${doc_us.iva} - {'✅' if doc_us.iva == expected_iva_us else '❌'}")
    print(f"   Total esperado: ${expected_total_us} - Actual: ${doc_us.total_general} - {'✅' if doc_us.total_general == expected_total_us else '❌'}")
...
try:
    ...
    print(f"   Técnico: {doc_cl.tecnico_responsable.nombre} (Empresa: {doc_cl.tecnico_responsable.empresa.pais})")
    ...
    print(f"   Técnico: {doc_us.tecnico_responsable.nombre} (Empresa: {doc_us.tecnico_responsable.empresa.pais})")
    
    # Verificar coherencia
    cl_coherente = (
        doc_cl.empresa.pais == "CL" and
        doc_cl.cliente.empresa.pais == "CL" and
        doc_cl.vehiculo.empresa.pais == "CL" and
        doc_cl.tecnico_responsable.empresa.pais == "CL"
    )
    
    us_coherente = (
        doc_us.empresa.pais == "US" and
        doc_us.cliente.empresa.pais == "US" and
        doc_us.vehiculo.empresa.pais == "US" and
        doc_us.tecnico_responsable.empresa.pais == "US"
    )
...
try:
    ...
    cl_correcto = (
        doc_cl.total_repuestos == Decimal("20000") and
        doc_cl.total_servicios == Decimal("5000") and
        doc_cl.total_otros == Decimal("3000") and
        doc_cl.iva == Decimal("3800") and
        doc_cl.total_general == Decimal("31800")
    )
    
    us_correcto = (
        doc_us.total_repuestos == Decimal("100") and
        doc_us.total_servicios == Decimal("50") and
        doc_us.total_otros == Decimal("0") and
        doc_us.iva == Decimal("0") and
        doc_us.total_general == Decimal("150")
    )
    ...
    if cl_correcto and us_correcto:
        ...
        print(f"   El backend calcula correctamente los totales")
        print(f"   Los cálculos coinciden con el frontend")
    else:
        print(f"\n❌ ALGUNAS PRUEBAS FALLARON")
        print(f"   Revisar los cálculos en el backend")
