        ...
        for cliente in clientes:
            ...
            if vehiculos_existentes.count() == 0:
                ...
                try:
                    ...
                    print(
                        f"✅ Vehículo creado: {vehiculo.patente} ({vehiculo.marca} {vehiculo.modelo})"
                    )
                ...
                for vehiculo in vehiculos_existentes:
                    print(
                        f"  - {vehiculo.patente} ({vehiculo.marca} {vehiculo.modelo})"
                    )
