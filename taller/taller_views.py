...
def dashboard_suscripciones(request):
    ...
    for empresa in empresas:
        ...
        )  # Usar directamente el campo nombre_taller
        empresas_con_taller.append({"empresa": empresa, "nombre_taller": nombre_taller})
    return render(
        request,
        "admin/suscripciones_dashboard.html",
        {"empresas_con_taller": empresas_con_taller},
    )
