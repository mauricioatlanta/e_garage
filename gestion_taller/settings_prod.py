...
# Django no soporta wildcards en CSRF_TRUSTED_ORIGINS; filtrar * para evitar 403 CSRF
...
# =============================================================================
# Forzar valores finales (evitar que env o herencia los rompan)
# =============================================================================
# 1. Forzar que collectstatic exista
if "django.contrib.staticfiles" not in INSTALLED_APPS:
    INSTALLED_APPS.append("django.contrib.staticfiles")

# 2. Permitir la IP y el dominio (Evitar DisallowedHost)
ALLOWED_HOSTS = ["egarage.cl", "www.egarage.cl", "159.223.200.106", "localhost", "127.0.0.1"]
