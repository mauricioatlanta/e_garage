...
def subir_comprobante(request):
    ...
    return render(request, 'suscripcion/subir_comprobante.html', {
        'empresa': request.user.empresa,
    })
...
def payment_success(request):
    ...
    messages.success(
        request,
        '✅ Pago recibido! Tu suscripción será activada en las próximas horas.'
    )
...
def payment_cancel(request):
    ...
    messages.warning(
        request,
        'Pago cancelado. Puedes intentar nuevamente cuando lo desees.'
    )
