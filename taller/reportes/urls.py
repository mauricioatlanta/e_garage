...
urlpatterns = [
    ...
    path(
        "inteligencia/",
        views.dashboard_inteligencia_operativa,
        name="inteligencia_operativa",
    ),
    ...
    path(
        ...
        name="generar_pdf_mecanico",
    ),
    path(
        "mecanicos/whatsapp/<int:mecanico_id>/",
        views.generar_resumen_whatsapp_mecanico,
        name="generar_resumen_whatsapp_mecanico",
    ),
    path(
        "api/mecanicos/chart-data/",
        views.api_mecanicos_chart_data,
        name="api_mecanicos_chart_data",
    ),
    # === API PARA DASHBOARD DE REPUESTOS ===
    path(
        "api/repuestos/chart-data/",
        views.api_repuestos_chart_data,
        name="api_repuestos_chart_data",
    ),
    # === NUEVAS RUTAS PARA REPORTES POR FECHA ===
    path("por-fecha/", views.reportes_por_fecha, name="reportes_por_fecha"),
    path(
        "repuestos-fecha/<str:desde>/<str:hasta>/",
        views.reportes_repuestos_fecha,
        name="reportes_repuestos_fecha",
    ),
    path(
        "servicios-fecha/<str:desde>/<str:hasta>/",
        views.reportes_servicios_fecha,
        name="reportes_servicios_fecha",
    ),
    path(
        "otros-fecha/<str:desde>/<str:hasta>/",
...
try:
    ...
    urlpatterns += [
        path(
            ...
            dashboard_rentabilidad,
            name="dashboard_rentabilidad",
        ),
        path("rentabilidad/", reportes_rentabilidad, name="reportes_rentabilidad"),
        path(
            "comparativo-precios/",
            reporte_comparativo_precios,
            name="reporte_comparativo_precios",
        ),
        path(
            "servicios-subcontratados/",
            reporte_servicios_subcontratados,
            name="reporte_servicios_subcontratados",
        ),
    ]
except ImportError:
