...
def actualizar_templates():
    ...
    actualizaciones = {
        ...
        # USA templates
        'usa.html': [
            (r'\$20<span class="text-lg font-normal">/mo</span>', '$20.00 USD<span class="text-lg font-normal">/mo</span>'),
            (r'\$110<span class="text-lg font-normal">/6mo</span>', '$110.00 USD<span class="text-lg font-normal">/6mo</span>'),
            (r'\$200<span class="text-lg font-normal">/year</span>', '$200.00 USD<span class="text-lg font-normal">/year</span>'),
        ],
