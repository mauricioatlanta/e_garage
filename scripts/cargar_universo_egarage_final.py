...
def cargar_universo_egarage():
    ...
    servicios_maestros = [
        {
            ...
            "local": {
                ...
                "AR": {
                    "label": "Gomería",
                    "aliases": ["parche", "cubierta", "auxilio", "goma", "reparación cubierta"],
                },
                ...
                "EC": {
                    "label": "Vulcanizadora",
                    "aliases": ["parche", "llanta", "vulcanización", "reparación llanta"],
                },
                "PE": {
                    "label": "Vulcanización",
                    "aliases": ["parche", "neumático", "vulcanizado", "reparación neumático"],
                },
                "VE": {
                    "label": "Vulcanización",
                    "aliases": ["parche", "caucho", "vulcanizado", "reparación caucho"],
                },
                "US": {
                    "label": "Tire Patch / Repair",
                    "aliases": ["flat tire", "plug", "puncture", "tire repair", "tire shop"],
                },
                "BR": {
                    "label": "Conserto de Pneu",
                    "aliases": ["furo", "borracharia", "remendo", "reparação pneu"],
                },
            },
        },
        {
            ...
            "local": {
                "CL": {
                    "label": "Desabolladura y Pintura",
                    "aliases": ["toque", "pintura", "desabollado", "chapa", "abolladura"],
                },
                "MX": {
                    "label": "Desabolladura y Pintura",
                    "aliases": ["golpe", "pintura", "desabollado", "chapa", "enderezado"],
                },
                "AR": {
                    "label": "Chapa y Pintura",
                    "aliases": ["chapista", "choque", "bollo", "pintura", "chapa"],
                },
                "UY": {
                    "label": "Chapa y Pintura",
                    "aliases": ["chapeado", "golpe", "pintura", "chapa"],
                },
                "CO": {
                    "label": "Latonería y Pintura",
                    "aliases": ["golpe", "latas", "pintar", "latonería", "enderezado"],
                },
                "EC": {
                    "label": "Enderezada y Pintura",
                    "aliases": ["choque", "enderezado", "pintura", "enderezar"],
                },
                "PE": {
                    "label": "Desabolladura y Pintura",
                    "aliases": ["golpe", "pintura", "desabollado", "chapa"],
                },
                "VE": {
                    "label": "Desabolladura y Pintura",
                    "aliases": ["golpe", "pintura", "desabollado", "chapa"],
                ...
                "US": {
                    "label": "Bodywork & Paint",
                    "aliases": ["dent repair", "pdr", "refinish", "bodywork", "paint"],
                },
                "BR": {
                    "label": "Funilaria e Pintura",
                    "aliases": ["funilaria", "amassado", "pintura", "chapa"],
                },
            },
        },
        {
            ...
            "local": {
                "CL": {
                    "label": "Afinamiento de Motor",
                    "aliases": ["limpieza inyectores", "bujías", "afinamiento", "tune up"],
                },
                "MX": {
                    "label": "Afinación Mayor",
                    "aliases": ["servicio", "bujías", "afinación", "tune up", "servicio mayor"],
                },
                "AR": {
                    "label": "Puesta a Punto / Service",
                    "aliases": ["afinación", "correa", "service", "puesta a punto", "tune up"],
                },
                "UY": {
                    "label": "Afinación de Motor",
                    "aliases": ["afinación", "bujías", "tune up", "servicio"],
                },
                "CO": {
                    "label": "Sincronización de Motor",
                    "aliases": ["afinación", "bujías", "sincronización", "tune up"],
                },
                "EC": {
                    "label": "ABC de Motor",
                    "aliases": ["mantenimiento", "limpieza", "abc", "tune up"],
                },
                "PE": {
                    "label": "Afinamiento de Motor",
                    "aliases": ["afinamiento", "bujías", "tune up", "servicio"],
                },
                "VE": {
                    "label": "Afinamiento de Motor",
                    "aliases": ["afinamiento", "bujías", "tune up", "servicio"],
                ...
                "US": {
                    ...
                    "aliases": ["spark plugs", "coils", "tune up", "engine service"],
                },
                "BR": {
                    "label": "Regulagem de Motor",
                    "aliases": ["regulagem", "velas", "tune up", "serviço motor"],
                },
            },
        },
        {
            ...
            "local": {
                "CL": {
                    ...
                    "aliases": ["mantención", "cambio de aceite", "aceite", "lubricación"],
                },
                "MX": {
                ...
                "AR": {
                    ...
                    "aliases": ["cambio de aceite", "aceite", "service", "lubricación"],
                },
                "UY": {
                    "label": "Cambio de Aceite",
                    "aliases": ["cambio de aceite", "aceite", "lubricación"],
                },
                "CO": {
                    "label": "Cambio de Aceite",
                    "aliases": ["cambio de aceite", "aceite", "lubricación"],
                ...
                "US": {
                    "label": "Oil Change",
                    "aliases": ["lube", "oil service", "oil change", "lubrication"],
                },
        ...
        },
        {
            ...
            "local": {
                "CL": {
                    ...
                    "aliases": ["pastillas", "frenos", "pastillas freno"],
                },
                "MX": {
                    "label": "Cambio de Balatas",
                    "aliases": ["balatas", "frenos", "pastillas", "balatas freno"],
                },
                "AR": {
                    "label": "Cambio de Pastillas de Freno",
                    "aliases": ["pastillas", "frenos", "pastillas freno"],
                ...
                "US": {
                    "label": "Brake Pads Replacement",
                    "aliases": ["brake pads", "pads", "brakes"],
                },
    ...
    for item in servicios_maestros:
        ...
        nombre_base = (
            item["local"].get("US", {}).get("label")
            or item["local"].get("CL", {}).get("label")
            or item["local"]
            .get(list(item["local"].keys())[0], {})
            .get("label", f"Servicio {item['code']}")
        )
        ...
        if not primera_categoria:
            print(
                f"⚠️  No se pudo crear categoría para {cat_code}, saltando servicio {item['code']}"
            )
            continue
