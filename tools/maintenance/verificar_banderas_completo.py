...
def verificar_templates_modificados():
    ...
    templates_check = [
        ('templates/taller/clientes/lista_clientes.html', 'include "components/country_badge.html"'),
        ('templates/taller/vehiculos/vehiculos.html', 'include "components/country_badge.html"'),
        ('templates/taller/servicios/lista.html', 'include "components/country_badge.html"'),
        ('templates/taller/servicios/servicios_menu.html', 'include "components/country_badge.html"'),
        ('templates/taller/servicios/servicios_local.html', 'include "components/country_badge.html"'),
        ('templates/taller/servicios/crear_servicio.html', 'include "components/country_badge.html"'),
        ('templates/taller/servicios/crear_otro_servicio.html', 'include "components/country_badge.html"'),
        ('templates/taller/repuesto_list.html', 'include "components/country_badge.html"'),
        ('templates/taller/repuesto_form.html', 'include "components/country_badge.html"'),
        ('templates/taller/otros_servicios_list.html', 'include "components/country_badge.html"'),
        ('templates/taller/documentos/lista_documentos.html', 'include "components/country_badge.html"'),
        ('templates/taller/documentos/documento_form.html', 'include "components/country_badge.html"'),
        ('documentos/templates/documentos/lista.html', 'include "components/country_badge.html"'),
