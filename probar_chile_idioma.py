#!/usr/bin/env python
"""
Script para probar el idioma con usuario de Chile
"""
...
def probar_chile_idioma():
    """Prueba el idioma con usuario de Chile"""
    print("🇨🇱 PROBANDO IDIOMA CON USUARIO DE CHILE")
    print("=" * 60)
    ...
    try:
        ...
        # 3. Hacer login como usuario de Chile (asumiendo que existe)
        print("3️⃣ Haciendo login como usuario de Chile...")

        # Intentar diferentes usuarios de Chile
        usuarios_chile = ["testuser_chile", "admin", "testuser"]

        login_exitoso = False
        for usuario in usuarios_chile:
            login_data = {
        ...
        if not login_exitoso:
            print("❌ No se pudo hacer login con ningún usuario de Chile")
            print("   Intentando con testuser_usa para comparar...")

            # Intentar con USA para comparar
            login_data = {
                "csrfmiddlewaretoken": csrf_token,
                "login": "testuser_usa",
                "password": "testpass123",
