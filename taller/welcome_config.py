...
WELCOME_CONFIG = {
    ...
    ("br", "es"): {
        **_LATAM_COMMON_ES,
        ...
        "c2_hex": "#FEDF00",
        "btn_text_color": "#000000",
        "hero_subtitle": "Software de gestión para talleres mecánicos, desarmadurías y casas de repuestos en São Paulo, Rio y Curitiba",
        "hero_image": "img/welcome/br/hero.webp",
        "terminology": [
            {"label": "Vehículo", "value": "Auto Usado"},
            {"label": "Documento", "value": "DUT / CRLV"},
            {"label": "Impuesto", "value": "IPVA / ICMS"},
        ],
        ...
        "features_footer": "En Brasil: desarmaduría · taller mecánico · casa de repuestos",
        ...
        "meta_description": "Software de gestión para talleres mecánicos, desarmadurías y casas de repuestos en Brasil. NF-e y PIX integrados. Prueba gratuita 30 días.",
        ...
        "priority_rubro": "taller",
        "market_insight": {
            "headline": "Más de 200.000 talleres mecánicos operan en Brasil.",
            "tip": "La NF-e automática, el PIX y el control de inventario son pilares del sector automotriz.",
            "focus": "Con eGarage digitalizas tu taller con NF-e automática y PIX integrado desde el primer día.",
        },
        "social_proof": {"stats": [
            {"value": "200K+", "label": "talleres en Brasil"},
    ...
    ("us", "en"): {
        ...
        "signup_url": "/us/en/accounts/signup/",
        "login_url": "/us/en/accounts/login/",
        ...
        "plans": [
            {"name": "Entry", "price": "$20", "period": "USD per month", "period_equiv": None, "savings": None, "popular": False,
             "features": _US_PLAN_FEATURES["entry"], "url": "/us/en/accounts/signup/?plan=monthly"},
            {"name": "Growth", "price": "$110", "period": "USD every 6 months", "period_equiv": None, "savings": "Save 17%", "popular": True,
             "features": _US_PLAN_FEATURES["growth"], "url": "/us/en/accounts/signup/?plan=semi-annual"},
            {"name": "Business", "price": "$200", "period": "USD per year", "period_equiv": None, "savings": "Save 33%", "popular": False,
             "features": _US_PLAN_FEATURES["business"], "url": "/us/en/accounts/signup/?plan=annual"},
        ],
    ...
    ("us", "es"): {
        **_LATAM_COMMON_ES,
        ...
        "business_types": _US_BUSINESS_TYPES,
        "signup_url": "/us/es/accounts/signup/",
        "login_url": "/us/es/accounts/login/",
        "precios_url": "/us/pricing/",
        "lang_switcher": {"es_url": "/us/es/bienvenida/", "en_url": "/us/en/bienvenida/"},
        "country_local": {
        ...
        "plans": [
            {"name": "Entry", "price": "$20", "period": "USD por mes", "period_equiv": None, "savings": None, "popular": False,
             "features": _LATAM_PLAN_FEATURES["entry"], "url": "/us/es/accounts/signup/?plan=monthly"},
            {"name": "Growth", "price": "$110", "period": "USD por 6 meses", "period_equiv": None, "savings": "Ahorra 17%", "popular": True,
             "features": _LATAM_PLAN_FEATURES["growth"], "url": "/us/es/accounts/signup/?plan=semi-annual"},
            {"name": "Business", "price": "$200", "period": "USD por año", "period_equiv": None, "savings": "Ahorra 33%", "popular": False,
             "features": _LATAM_PLAN_FEATURES["business"], "url": "/us/es/accounts/signup/?plan=annual"},
        ],
