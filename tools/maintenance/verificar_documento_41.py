...
def verificar_documento_41():
    ...
    try:
        ...
        for vehiculo in vehiculos_cliente:
            print(
                f"   - ID {vehiculo.id}: {vehiculo.patente} - {vehiculo.marca.nombre} {vehiculo.modelo.nombre}"
            )
        ...
        for vehiculo in vehiculos_empresa:
            print(
                f"   - ID {vehiculo.id}: {vehiculo.patente} - {vehiculo.marca.nombre} {vehiculo.modelo.nombre} (Cliente: {vehiculo.cliente.nombre})"
            )
