...
def main():
    ...
    for modelo in modelos_numericos:
        print(
            f"  🔍 Modelo problemático: ID {modelo.id}, Nombre: '{modelo.nombre}', Marca: {modelo.marca}"
        )
    ...
    print("   1. Actualizar vehículo CCWH63 con marca/modelo correctos")
    print("   2. Eliminar marca numérica '8' y modelo numérico '38'")
    print("   3. Asignar marca y modelo apropiados según lo que debería ser")
