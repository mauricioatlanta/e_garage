...
def test_repuesto_form():
    ...
    try:
        ...
        assert (
            repuesto.precio_compra == 12500
        ), f"Precio compra incorrecto: {repuesto.precio_compra}"
        assert (
            repuesto.precio_venta == 18900
        ), f"Precio venta incorrecto: {repuesto.precio_venta}"
