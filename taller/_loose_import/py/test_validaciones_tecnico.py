...
def test_unicidad_case_insensitive():
    ...
    if tecnico_existente:
        ...
        try:
            ...
            nombre_variante = nombre_existente.upper() if nombre_existente.islower() else nombre_existente.lower()
            ...
            print(f"   ✅ Unicidad funcionó: No se pudo crear duplicado")
            print(f"   Error: {e}")
    else:
