...
def sugerencias_basicas_demo(request):
    ...
    sugerencias_por_vehiculo = {
        "toyota": {
            "servicios_comunes": [
                {
                    "nombre": "Cambio de Aceite Toyota 0W-20",
                    "precio": 85000,
                    "frecuencia": "Cada 10,000 km",
                },
                {
                    "nombre": "Filtros Toyota Originales",
                    "precio": 45000,
                    "frecuencia": "Cada 20,000 km",
                },
                {
                    "nombre": "Revisión Híbrida",
                    "precio": 180000,
                    "frecuencia": "Cada 40,000 km",
                },
            ],
        ...
        "nissan": {
            "servicios_comunes": [
                {
                    "nombre": "Cambio de Aceite Nissan 5W-30",
                    "precio": 75000,
                    "frecuencia": "Cada 8,000 km",
                },
                {
                    "nombre": "Alineación CVT Nissan",
                    "precio": 95000,
                ...
                },
                {
                    ...
                    "precio": 350000,
                    "frecuencia": "Cada 60,000 km",
                },
            ],
            "repuestos_frecuentes": [
                {
                    "nombre": "Filtro CVT Nissan",
                    "precio": 65000,
                    "codigo": "NIS-CVT-089",
                },
        ...
        "general": {
            "servicios_comunes": [
                {
                    "nombre": "Cambio de Aceite Convencional",
                    "precio": 65000,
            ...
            "repuestos_frecuentes": [
                ...
                {
                    "nombre": "Pastillas Freno Genéricas",
                    "precio": 85000,
                    "codigo": "UNI-PF-050",
                },
...
def obtener_sugerencias_vehiculo(request, marca):
    ...
    sugerencias_data = {
        "toyota": {
            ...
            "servicios_recomendados": [
                {
                    "nombre": "Cambio de Aceite Sintético Toyota",
                    "precio": 85000,
                    "urgencia": "Media",
                },
                {
            ...
            "repuestos_preventivos": [
                {
                    "nombre": "Filtro Aire Cabina Toyota",
                    "precio": 45000,
                    "stock": "Disponible",
                },
        ...
        "nissan": {
            ...
            "servicios_recomendados": [
                ...
                {
                    "nombre": "Cambio Aceite Específico Nissan",
                    "precio": 75000,
                    "urgencia": "Media",
                },
            ],
            "repuestos_preventivos": [
                ...
                {
                    "nombre": "Sensor Posición Árbol Levas",
                    "precio": 180000,
                    "stock": "Disponible",
                },
            ],
    ...
    return JsonResponse({"success": True, "marca": marca, "data": data})
...
def demo_sugerencias_vehiculo(request):
    ...
    return render(request, "ia/demo_vehiculo.html", {"demo_data": demo_data})
