...
class CategoriaServicio(models.Model):
    ...
    code = models.CharField(max_length=50, null=True, blank=True, help_text="Código único para reportes/lógica")
...
class SubcategoriaServicio(models.Model):
    ...
    country = models.CharField(max_length=2, choices=CategoriaServicio.COUNTRY_CHOICES, default='CL')
    code = models.CharField(max_length=50, null=True, blank=True, help_text="Código único para reportes/lógica")
...
class SubcategoriaServicioName(models.Model):
    ...
    subcategoria = models.ForeignKey(SubcategoriaServicio, on_delete=models.CASCADE, related_name='names')
...
class Servicio(TenantScoped):
    ...
    subcategoria = models.ForeignKey('SubcategoriaServicio', on_delete=models.PROTECT, null=True, blank=True, db_index=True)
    ...
    class Meta(TenantScoped.Meta):
        ...
        constraints = [
            UniqueConstraint(fields=['empresa','nombre','categoria'],
...
class ServicioExterno(TenantScoped):
    ...
    nombre = models.CharField(max_length=160, db_index=True, help_text="Nombre del servicio externo")
    empresa_externa = models.CharField(max_length=255, help_text="Nombre de la empresa que realiza el servicio")
    categoria = models.ForeignKey('CategoriaServicio', on_delete=models.PROTECT, db_index=True)
    subcategoria = models.ForeignKey('SubcategoriaServicio', on_delete=models.PROTECT, null=True, blank=True, db_index=True)
    ...
    tiempo_estimado = models.CharField(max_length=100, blank=True, null=True, help_text="Tiempo estimado del servicio")
    ...
    class Meta(TenantScoped.Meta):
        ...
        constraints = [
            UniqueConstraint(fields=['empresa', 'nombre', 'empresa_externa'],
