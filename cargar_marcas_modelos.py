...
for marca_nombre, modelos in marcas_y_modelos.items():
    marca_obj, created = Marca.objects.get_or_create(nombre=marca_nombre)
    for modelo_nombre in modelos:
        Modelo.objects.get_or_create(nombre=modelo_nombre, marca=marca_obj)

print("Carga de marcas y modelos completada.")
