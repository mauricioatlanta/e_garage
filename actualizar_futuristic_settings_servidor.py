#!/usr/bin/env python
"""
Script para actualizar futuristic_company_settings_views.py en el servidor
"""
import os

file_path = "/home/atlantareciclajes/apps/egarage/releases/2025-11-17_1615_eg/taller/views_extra/futuristic_company_settings_views.py"
...
print("=" * 70)
print("ACTUALIZANDO futuristic_company_settings_views.py")
print("=" * 70)

# Crear backup del archivo original
backup_path = file_path + ".bak_" + str(int(__import__("time").time()))
try:
...
try:
    ...
    print(f"✅ Líneas: {lines} líneas")

    # Verificar que el archivo tiene el contenido correcto
    with open(file_path, "r", encoding="utf-8") as f:
        first_lines = f.readlines()[:5]
        if "Usa el mismo template que company_settings_view" in "".join(first_lines):
            print("✅ Verificación: El archivo contiene los cambios correctos")
        else:
            print("⚠️  Advertencia: No se encontró el texto esperado")
