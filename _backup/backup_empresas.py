...
class BackupEmpresa:
    ...
    def _backup_vehiculos(self, empresa, backup_path):
        ...
        try:
            ...
            if vehiculos.exists():
                ...
                print("   🚗 No hay vehículos para exportar")
        except Exception as e:
    ...
    def _backup_documentos(self, empresa, backup_path):
        ...
        if documentos.exists():
            ...
            if repuestos.exists():
                ...
                with open(
                    os.path.join(backup_path, "repuestos_documentos.json"),
                    "w",
                    encoding="utf-8",
                ) as f:
                    f.write(data)
            ...
            if servicios.exists():
                ...
                with open(
                    os.path.join(backup_path, "servicios_documentos.json"),
                    "w",
                    encoding="utf-8",
                ) as f:
                    f.write(data)
            ...
            print("   📄 No hay documentos para exportar")
    ...
    def _backup_auditoria(self, empresa, backup_path):
        ...
        if logs.exists():
            ...
            print("   📊 No hay logs de auditoría para exportar")
