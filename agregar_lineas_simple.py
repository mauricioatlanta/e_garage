    ...
    for doc in documentos:
        ...
        try:
            LineaServicio.objects.get_or_create(
                ...
                defaults={
                    'cantidad': 1,
                    'precio_unitario': Decimal('50000') if doc.empresa.pais == 'CL' else Decimal('89.99'),
                    'descuento': Decimal('0.00'),
                    'observaciones': 'Servicio de cambio de aceite completo'
                }
            )
            print(f"   ✅ Servicio agregado")
        ...
        try:
            LineaRepuesto.objects.get_or_create(
                ...
                defaults={
                    'cantidad': 1,
                    'precio_unitario': Decimal('8500') if doc.empresa.pais == 'CL' else Decimal('24.99'),
                    'descuento': Decimal('0.00'),
