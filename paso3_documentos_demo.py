...
class DocumentosDemo:
        ...
        for empresa in empresas_cl:
            ...
            for cliente in clientes:
                ...
                for vehiculo in vehiculos:
                    ...
                    servicios_seleccionados = random.sample(list(servicios_cl), k=random.randint(2, 4))
                    ...
                    print(f"   ✅ Cotización #{documento.pk} - {cliente.nombre} {cliente.apellido} - ${total_documento:,.0f}")
        ...
        for empresa in empresas_us:
            ...
            for cliente in clientes:
                ...
                for vehiculo in vehiculos:
                    ...
                    # Agregar servicios aleatorios
                    servicios_seleccionados = random.sample(list(servicios_us), k=random.randint(2, 4))
                    total_documento = Decimal('0.00')
                    ...
                    documentos_creados += 1
                    print(f"   ✅ Estimate #{documento.pk} - {cliente.nombre} {cliente.apellido} - ${total_documento}")
    ...
    def generar_reporte_final_paso3(self):
        ...
        for empresa in empresas_demo:
            ...
            print(f"      👥 {clientes_emp} clientes | 🚗 {vehiculos_emp} vehículos | 📄 {documentos_emp} documentos")
