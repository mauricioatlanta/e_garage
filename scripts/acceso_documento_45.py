...
from django.shortcuts import render  # Importar render para devolver respuestas HTTP
...
def main():
    ...
    try:
        ...
        print("Para acceder al documento 45, necesitas:")
        print(f"1. Iniciar sesión como: {username}")
        print("2. Visitar la URL: http://127.0.0.1:8000/us/documentos/form/45/")
