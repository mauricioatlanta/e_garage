    ...
    def handle(self, *args, **options):
        ...
        for empresa in empresas:
            try:
                ...
                # Renderizar email
                html_message = render_to_string('email/recordatorio_vencimiento.html', {
                    'empresa': empresa,
                    'plan': empresa.plan,
                ...
                if dry_run:
                    self.stdout.write(f"[DRY-RUN] Enviaría email a: {empresa.email} ({empresa.nombre_taller})")
                else:
                    # Enviar email
                    send_mail(
                        subject=subject,
                    ...
                    self.stdout.write(self.style.SUCCESS(f"✅ Email enviado a: {empresa.email} ({empresa.nombre_taller})"))
