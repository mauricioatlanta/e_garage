...
def test_documento_rechaza_fk_de_otra_empresa(client):
    ...
    emp1 = Empresa.objects.create(nombre_taller="E1", pais="CL", user=User.objects.create_user(username="emp1", password="x"))
    emp2 = Empresa.objects.create(nombre_taller="E2", pais="CL", user=User.objects.create_user(username="emp2", password="x"))
    ...
    veh = Vehiculo.objects.create(empresa=emp2, cliente=cli2, patente="MMS123", marca_texto="X", modelo_texto="Y", anio=2019)
    ...
    url = _rev(["taller:documentos_api_create","documentos:api_create","documentos_api_create"], "/cl/documentos/api/create/")
