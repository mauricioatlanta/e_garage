#!/usr/bin/env python3
"""
Script para cargar modelos USA directamente sin pasar por checks de Django
Ejecutar: python3.10 SCRIPT_CARGAR_MODELOS_USA_DIRECTO.py
"""
...
# Configurar Django sin checks
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "gestion_taller.settings")
os.environ["DJANGO_SKIP_CHECKS"] = "1"
...
print("🚗 Cargando modelos de vehículos para USA\n")
...
for item in marcas_con_modelos:
    print(f"  {item['marca__nombre']}: {item['total']} modelos")
