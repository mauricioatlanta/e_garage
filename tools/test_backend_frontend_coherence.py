...
try:
    ...
    print(f"   Repuestos: {'✅' if rep_ok else '❌'} (Backend: ${doc_cl.total_repuestos} vs Frontend: ${expected_repuestos})")
    print(f"   Servicios: {'✅' if serv_ok else '❌'} (Backend: ${doc_cl.total_servicios} vs Frontend: ${expected_servicios})")
    print(f"   Otros: {'✅' if otros_ok else '❌'} (Backend: ${doc_cl.total_otros} vs Frontend: ${expected_otros})")
    print(f"   IVA: {'✅' if iva_ok else '❌'} (Backend: ${doc_cl.iva} vs Frontend: ${expected_iva})")
    print(f"   TOTAL: {'✅' if total_ok else '❌'} (Backend: ${doc_cl.total_general} vs Frontend: ${expected_total})")
...
try:
    ...
    print(f"   Repuestos: {'✅' if rep_ok_us else '❌'} (Backend: ${doc_us.total_repuestos} vs Frontend: ${expected_repuestos_us})")
    print(f"   Servicios: {'✅' if serv_ok_us else '❌'} (Backend: ${doc_us.total_servicios} vs Frontend: ${expected_servicios_us})")
    print(f"   Otros: {'✅' if otros_ok_us else '❌'} (Backend: ${doc_us.total_otros} vs Frontend: ${expected_otros_us})")
    print(f"   Sales Tax: {'✅' if iva_ok_us else '❌'} (Backend: ${doc_us.iva} vs Frontend: ${expected_iva_us})")
    print(f"   TOTAL: {'✅' if total_ok_us else '❌'} (Backend: ${doc_us.total_general} vs Frontend: ${expected_total_us})")
...
try:
    ...
    if cl_correcto and us_correcto:
        ...
        print(f"   Los cálculos del backend coinciden exactamente con el frontend")
        print(f"   El sistema está listo para producción")
    else:
        print(f"\n❌ HAY DISCREPANCIAS EN LOS CÁLCULOS")
        print(f"   Revisar la implementación de los métodos de cálculo")
