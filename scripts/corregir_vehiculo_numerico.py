    ...
    try:
        ...
        if toyota:
            ...
            if toyota and corolla:
                ...
                print("   ✅ Datos numéricos problemáticos eliminados")

            else:
                print("❌ Error: No se encontró Toyota Corolla para Chile")
        else:
            print("❌ Error: No se encontró marca Toyota para Chile")

    except Vehiculo.DoesNotExist:
        print("❌ Error: Vehículo CCWH63 no encontrado")
