...
urlpatterns = [
    ...
    path("<int:pk>/pdf-weasyprint/", views_ejemplo.documento_pdf_weasyprint, name="pdf_weasyprint"),
    path("<int:pk>/pdf-wkhtmltopdf/", views_ejemplo.documento_pdf_wkhtmltopdf, name="pdf_wkhtmltopdf"),
]
