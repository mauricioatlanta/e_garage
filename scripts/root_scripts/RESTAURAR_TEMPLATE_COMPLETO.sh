#!/bin/bash
# Script para restaurar completamente el template desde el repositorio local
# O reescribirlo desde cero si es necesario
...
echo "🔧 Restaurando template desde Git o reescribiéndolo..."
...
# Intentar restaurar desde Git primero
import subprocess
try:
    ...
    if result.returncode == 0:
        ...
        print("⚠️  No se pudo restaurar desde Git, reescribiendo...")
except:
    print("⚠️  Git no disponible, reescribiendo archivo...")

# Si no se pudo restaurar, reescribir el archivo completo
...
print("✅ Archivo reescrito completamente con estructura correcta")
print("✅ Todo el CSS está dentro de <style> y </style>")
PYEOF
...
echo "   3. Si persiste, verifica que no haya otro template siendo usado"
