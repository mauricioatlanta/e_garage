#!/usr/bin/env python
"""
Script para probar con testuser_cl (Chile)
"""
...
def probar_testuser_cl():
    """Prueba con testuser_cl (usuario de Chile)"""
    print("🇨🇱 PROBANDO CON TESTUSER_CL (CHILE)")
    print("=" * 60)
    ...
    try:
        ...
        if login_response.status_code == 200 and "login" not in login_response.url:
            print("✅ Login exitoso como testuser_cl")
        else:
