...
def verificar_setup():
    ...
    print("\n📍 PRÓXIMO PASO:")
    print("Ir a http://127.0.0.1:8000/cl/taller/settings/")
    print("Subir una imagen y presionar 💾 UPDATE PROFILE")
    print("Revisar console para logs con 🧪 DEBUG")
