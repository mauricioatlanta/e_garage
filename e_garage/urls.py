...
urlpatterns = [
    ...
    path('', TemplateView.as_view(template_name='selector-pais-egarage.html'), name='home'),
    ...
    path('accounts/resend-email/', __import__('taller.views_extra.resend_email', fromlist=['resend_email_view']).resend_email_view, name='resend_email'),
