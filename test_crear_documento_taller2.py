...
def test_crear_documento_taller2():
    ...
    print(
        f"Clientes disponibles en {empresa_mecanica.nombre_taller}: {clientes.count()}"
    )
    ...
    post_data = {
        ...
        "json_items": json.dumps(
            [
                ...
                {"tipo": "servicio", "nombre": "Servicio de Prueba", "precio": 25000},
            ]
        ),
    }
    ...
    try:
        ...
        documentos_nuevos = Documento.objects.filter(
            empresa=empresa_mecanica, numero="F-TEST-001"
        )
