...
def main():
    ...
    try:
        ...
        colores_inglés_keywords = ['red', 'blue', 'green', 'black', 'white', 'yellow', 'gray', 'grey', 'brown', 'silver', 'gold']
        colores_español_keywords = ['rojo', 'azul', 'verde', 'negro', 'blanco', 'amarillo', 'gris', 'café', 'marrón', 'plateado', 'dorado']
