...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if settings.DEBUG:
            ...
            self.stdout.write(f'✅ CSRF_TRUSTED_ORIGINS configurado para desarrollo: {settings.CSRF_TRUSTED_ORIGINS}')
        else:
            ...
            self.stdout.write(f'✅ CSRF_TRUSTED_ORIGINS configurado para producción: {settings.CSRF_TRUSTED_ORIGINS}')
