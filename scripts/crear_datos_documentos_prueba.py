...
from taller.models import (Cliente, Documento, Empresa, LineaOtroServicio,
                           LineaRepuesto, LineaServicio, OtroServicio,
                           Repuesto, TipoServicio, Vehiculo)
...
def crear_datos_prueba():
    ...
    for doc in Documento.objects.all():
        ...
        print(f"Doc {doc.numero_documento}: {rep_count} rep, {serv_count} serv, {otros_count} otros")
