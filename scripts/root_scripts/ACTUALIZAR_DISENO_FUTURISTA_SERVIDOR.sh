#!/bin/bash
# Script para actualizar el diseño futurista en el servidor
...
echo "🚀 Actualizando diseño futurista..."
...
<head>
  ...
  <style>
    * { 
    ...
    body {
      background: linear-gradient(135deg, #0a0a23 0%, #1a1a2e 50%, #0f1419 100%);
    ...
    .country-btn.usa:hover {
      transform: translateY(-4px) scale(1.02);
      box-shadow: 0 12px 40px rgba(0, 80, 179, 0.6);
      border-color: #00e6ff;
    }
    ...
    .country-btn.chile:hover {
      transform: translateY(-4px) scale(1.02);
      box-shadow: 0 12px 40px rgba(213, 43, 30, 0.6);
      border-color: #00e6ff;
    }
    ...
    .country-btn.venezuela:hover {
      transform: translateY(-4px) scale(1.02);
      box-shadow: 0 12px 40px rgba(255, 204, 0, 0.6);
      border-color: #CF142B;
    }
    ...
    .country-btn.mexico:hover {
      transform: translateY(-4px) scale(1.02);
      box-shadow: 0 12px 40px rgba(0, 99, 65, 0.6);
      border-color: #CE1126;
    }
    ...
    .country-btn.colombia:hover {
      transform: translateY(-4px) scale(1.02);
      box-shadow: 0 12px 40px rgba(252, 209, 22, 0.6);
      border-color: #CE1126;
    }
...
echo "✅ Diseño futurista actualizado"
