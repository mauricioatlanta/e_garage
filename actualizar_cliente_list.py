...
def actualizar_cliente_list():
    ...
    base_path = os.getcwd()
    source_template = os.path.join(base_path, 'templates_canonical', 'taller', 'cl', 'es', 'clientes', 'cliente_list.html')
    ...
    print(f"• 🔧 Variable corregida: 'clientes' → 'cliente_list'")
    print(f"• 📊 Listado de clientes ahora funciona correctamente")
