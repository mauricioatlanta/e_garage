...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.WARNING(f'⚠ Múltiples empresas encontradas, usando: {empresa.nombre_taller}'))
        ...
        nombres_repuestos = [
            ...
            "Batería 12V", "Aceite Motor 5W-30", "Radiador", "Termostato",
            "Bomba de Agua", "Correa de Distribución", "Bujías",
            "Amortiguadores Delanteros", "Amortiguadores Traseros", "Rótulas",
            "Bieletas", "Terminales", "Discos de Freno", "Tambores de Freno"
        ]
        ...
        servicios = []
        nombres_servicios = [
            "Cambio de Aceite", "Alineación y Balanceo", "Revisión General",
            "Cambio de Filtros", "Revisión de Frenos", "Cambio de Batería",
            "Revisión de Suspensión", "Limpieza de Inyectores", "Diagnóstico Computarizado",
            "Mantenimiento Preventivo", "Reparación de Motor", "Reparación de Transmisión"
        ]
        ...
        otros_servicios = []
        nombres_otros = [
            "Pintura Completa", "Tapicería", "Cristalería",
            "Hojalatería", "Enderezado", "Soldadura"
        ]
        ...
        nombres_clientes = [
            ...
            "Roberto", "Patricia", "Fernando", "Sandra", "Miguel", "Andrea",
            "Diego", "Natalia", "Ricardo", "Valentina", "Andrés", "Camila",
            "Jorge", "Isabella", "Francisco", "Daniela", "Sebastián", "Francisca",
            "Rodrigo", "Javiera", "Felipe", "Constanza"
        ]
        ...
        nombres_marcas = ["Toyota", "Nissan", "Chevrolet", "Ford", "Hyundai", "Kia", "Mazda", "Suzuki"]
        ...
        for i, cliente in enumerate(clientes):
            ...
            for j in range(num_vehiculos):
                ...
                while Vehiculo.objects.filter(empresa=empresa, patente=patente).exists():
                    patente = f"{random.choice(['ABCD', 'EFGH', 'IJKL'])}{random.randint(10000, 99999)}"
                    contador += 1
        ...
        for i in range(20):
            ...
            if random.random() < 0.5:
                ...
                costo_interno = (precio * Decimal('0.6')).quantize(Decimal('0.01'))  # 60% del precio
                neto_otros += precio
