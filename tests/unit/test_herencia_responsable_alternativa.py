...
def test_herencia_documento_con_tecnico_linea_sin_tecnico():
    ...
    if response.status_code in (200, 201):
        ...
        assert documento.tecnico_responsable == tecnico_doc, "Document should have tecnico_responsable"
        
        # Line should inherit from document
        assert linea.tecnico_responsable == tecnico_doc, "Line should inherit tecnico_responsable from document"
...
def test_herencia_documento_con_tecnico_linea_con_tecnico_diferente():
    ...
    if response.status_code in (200, 201):
        ...
        assert documento.tecnico_responsable == tecnico_doc, "Document should have its tecnico_responsable"
        
        # Line should keep its own tecnico (not inherit from document)
        assert linea.tecnico_responsable == tecnico_linea, "Line should keep its own tecnico_responsable"
...
def test_herencia_documento_sin_tecnico_linea_con_tecnico():
    ...
    if response.status_code in (200, 201):
        ...
        assert linea.tecnico_responsable == tecnico_linea, "Line should have its own tecnico_responsable"
...
def test_herencia_mixta_multiple_lineas():
    ...
    if response.status_code in (200, 201):
        ...
        assert lineas_servicio[0].tecnico_responsable == tecnico_doc, "First service line should inherit from document"
        
        # Second service line should have its own tecnico
        assert lineas_servicio[1].tecnico_responsable == tecnico_linea1, "Second service line should have its own tecnico"
        
        # First repuesto line should inherit from document
        assert lineas_repuesto[0].tecnico_responsable == tecnico_doc, "First repuesto line should inherit from document"
        
        # Second repuesto line should have its own tecnico
        assert lineas_repuesto[1].tecnico_responsable == tecnico_linea2, "Second repuesto line should have its own tecnico"
