...
def test_pais_utils_functions():
    ...
    try:
        from taller.utils.pais_utils import get_country_code, format_currency, validate_country
    except ImportError:
...
def test_us_localization_functions():
    ...
    try:
        from taller.utils.us_localization import format_phone, format_address, format_zip_code
    except ImportError:
...
def test_templates_utils():
    ...
    try:
        from taller.utils.templates import render_template_string, get_template_context
    except ImportError:
...
def test_smart_logging_functions():
    ...
    try:
        from taller.utils.smart_logging import format_log_message, sanitize_data, get_log_level
    except ImportError:
