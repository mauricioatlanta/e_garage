...
def test_documentos_totales_json_estricto_sin_redirect(client):
    ...
    veh = Vehiculo.objects.create(
        empresa=emp, cliente=cli, patente="ABC123", marca_texto="M", modelo_texto="X", anio=2024
    )
    ...
    payload = {
        ...
        "lineas_servicio": [{"nombre": "Srv", "cantidad": 2, "precio_unitario": 1000, "descuento": 0}],
        "lineas_repuesto": [{"nombre": "Rep", "cantidad": 1, "precio_unitario": 500, "descuento": 0}],
    }
