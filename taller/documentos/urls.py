...
if descargar_documento_pdf is not None:
    urlpatterns.extend([
        path("<int:documento_id>/pdf/", descargar_documento_pdf, name="descargar_documento_pdf"),
        path("<int:documento_id>/imprimir/", imprimir_documento, name="imprimir_documento"),
        path("<int:documento_id>/whatsapp/", compartir_documento_whatsapp, name="compartir_documento_whatsapp"),
        path("<int:documento_id>/email/", enviar_documento_email, name="enviar_documento_email"),
