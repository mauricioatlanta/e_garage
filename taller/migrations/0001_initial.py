# Generated by Django 5.1.6 on 2025-08-22 23:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estado",
                    models.CharField(db_index=True, default="DRAFT", max_length=12),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item_type",
                    models.CharField(
                        choices=[("PART", "Repuesto"), ("SERV", "Servicio")],
                        db_index=True,
                        max_length=4,
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["empresa", "item_type"], name="taller_line_empresa_ddb0d7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="lineadocumento",
            index=models.Index(
                fields=["empresa", "documento"], name="taller_line_empresa_c2672a_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="lineadocumento",
            constraint=models.CheckConstraint(
                condition=models.Q(("qty__gt", 0)), name="ck_linea_qty_pos"
            ),
        ),
        migrations.AddConstraint(
            model_name="lineadocumento",
            constraint=models.CheckConstraint(
                condition=models.Q(("unit_price__gte", 0)), name="ck_linea_price_nonneg"
            ),
        ),
        migrations.AddIndex(
            model_name="modelo",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["country", "modelo", "nombre"],
                name="taller_caja_country_366f6a_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="cajavehiculo",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["country", "modelo", "nombre"],
                name="taller_moto_country_666952_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="motorvehiculo",
