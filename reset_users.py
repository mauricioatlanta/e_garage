...
from taller.models import Empresa, Documento, Repuesto, Cliente, Vehiculo
...
try:
    ...
    print(f'   Username: chile_test')
    print(f'   Email: chile@test.com')
    print(f'   Password: Chile2024!')
    print(f'   País: 🇨🇱 Chile\n')
...
try:
    ...
    print(f'   Username: usa_test')
    print(f'   Email: usa@test.com')
    print(f'   Password: Usa2024!')
    print(f'   País: 🇺🇸 USA\n')
