...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            f"📋 Estado actual - Repuestos: {lineas_rep_actual}, Servicios: {lineas_serv_actual}"
        )
        ...
        if lineas_rep_actual == 0:
            ...
            self.stdout.write(self.style.SUCCESS("✅ Líneas de repuesto creadas:"))
            self.stdout.write(
        ...
        if lineas_serv_actual == 0:
            ...
            self.stdout.write(self.style.SUCCESS("✅ Líneas de servicio creadas:"))
            self.stdout.write(
        ...
        try:
            ...
            if total_rep > 0 or total_serv > 0:
                ...
                self.stdout.write(
                    "Recargar: http://127.0.0.1:8000/us/documentos/us/ o http://127.0.0.1:8000/cl/documentos/cl/"
                )
            else:
                self.stdout.write(
