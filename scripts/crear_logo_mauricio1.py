...
try:
    ...
    draw.text((width//2, height//2-20), "TURBO", font=font_large, fill='white', anchor='mm')
    draw.text((width//2, height//2+15), "AUTOMOTIVE", font=font_small, fill='#00ffff', anchor='mm')
