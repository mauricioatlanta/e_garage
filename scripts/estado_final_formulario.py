...
def main():
    ...
    print("   2. Al seleccionar marca: Cargar modelos vía AJAX")
    print("   3. Al enviar formulario: Guardar usando IDs correctos")
    print("   4. Al listar vehículos: Mostrar nombres (no IDs)")
