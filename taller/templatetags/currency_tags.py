...
def format_currency(context, amount):
    ...
    formats = {
        "CL": {"symbol": "$", "decimal_pos": 0, "thousand_sep": ".", "decimal_sep": ","},
        "US": {"symbol": "$", "decimal_pos": 2, "thousand_sep": ",", "decimal_sep": "."},
        "BR": {"symbol": "R$", "decimal_pos": 2, "thousand_sep": ".", "decimal_sep": ","},
        "MX": {"symbol": "$", "decimal_pos": 2, "thousand_sep": ",", "decimal_sep": "."},
        "CO": {"symbol": "$", "decimal_pos": 0, "thousand_sep": ".", "decimal_sep": ","},
        "AR": {"symbol": "$", "decimal_pos": 2, "thousand_sep": ".", "decimal_sep": ","},
        "PE": {"symbol": "S/", "decimal_pos": 2, "thousand_sep": ",", "decimal_sep": "."},
        "EC": {"symbol": "$", "decimal_pos": 2, "thousand_sep": ".", "decimal_sep": ","},
        "VE": {"symbol": "Bs.", "decimal_pos": 2, "thousand_sep": ".", "decimal_sep": ","},
        "UY": {"symbol": "$", "decimal_pos": 2, "thousand_sep": ".", "decimal_sep": ","},
    }
