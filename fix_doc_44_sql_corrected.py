...
def agregar_servicios_documento_44():
    ...
    # Mostrar detalles
    cursor.execute("SELECT nombre, cantidad, precio_unitario FROM taller_lineaservicio WHERE documento_id = 44")
    ...
    cursor.execute("SELECT nombre, cantidad, precio_unitario FROM taller_lineaotroservicio WHERE documento_id = 44")
