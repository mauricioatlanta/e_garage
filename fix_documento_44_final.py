    ...
    try:
        ...
        if servicios_disponibles.exists():
            ...
            for i, servicio in enumerate(servicios_disponibles, 1):
                ...
                print(f"✅ Servicio creado: {linea_servicio.nombre} - ${linea_servicio.precio_unitario}")
        ...
        for codigo, nombre, cantidad, precio in repuestos_ejemplo:
            ...
            print(f"✅ Repuesto creado: {repuesto.nombre} x{repuesto.cantidad} - ${repuesto.precio_unitario}")
