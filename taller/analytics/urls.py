...
urlpatterns = [
    ...
    path(
        ...
        detalle_suscriptor,
        name="detalle_suscriptor",
    ),
    # === DASHBOARD AVANZADO ===
    path(
        "admin/dashboard/avanzado/",
        admin_views.dashboard_avanzado,
    ...
    path(
        "admin/dashboard/recordatorio/<int:empresa_id>/",
        enviar_recordatorio_expiracion,
    ...
    path(
        "admin/dashboard/realtime-new/",
        apis_avanzadas.dashboard_realtime_metrics,
        name="api_realtime_new",
    ),
    path(
        "admin/dashboard/predictive-new/",
        apis_avanzadas.dashboard_predictive_analytics,
        name="api_predictive_new",
    ),
    path(
        "admin/dashboard/geographic-new/",
        apis_avanzadas.dashboard_geographic_analysis,
        name="api_geographic_new",
    ),
    path(
        "admin/dashboard/alertas-new/",
        apis_avanzadas.dashboard_alertas_avanzadas,
        name="api_alertas_new",
    ),
    path(
        "admin/dashboard/behavior-new/",
        apis_avanzadas.dashboard_user_behavior,
        name="api_behavior_new",
    ),
    path(
        "admin/dashboard/stats/",
        apis_avanzadas.dashboard_stats_general,
        name="api_stats",
    ),
    path(
        "admin/dashboard/recordatorio-new/<int:empresa_id>/",
        apis_avanzadas.enviar_recordatorio_empresa,
        name="enviar_recordatorio_new",
    ),
