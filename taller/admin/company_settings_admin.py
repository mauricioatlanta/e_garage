...
class CompanySettingsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Branding Visual', {
            'fields': ('logo', 'display_logo_large', 'primary_color', 'secondary_color', 'color_preview'),
            'classes': ('collapse',)
        }),
        ('Datos de Contacto', {
    ...
    def has_custom_colors(self, obj):
        ...
        has_custom = (obj.primary_color != default_primary or 
                      obj.secondary_color != default_secondary)
