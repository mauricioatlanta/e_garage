...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "taller.context_processors.company_branding",  # Branding con logo y nombre
                "taller.context_processors.company_header",  # ✅ NUEVO - Información de contacto
            ],
        },
    },
]
...
ACCOUNT_LOGOUT_REDIRECT_URL = (
    "/logout-redirect/"  # Redirigir a nuestra vista personalizada
)
