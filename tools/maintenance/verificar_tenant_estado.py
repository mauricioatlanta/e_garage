...
def main():
    ...
    try:
        ...
        for vehiculo in vehiculos_muestra:
            ...
            cliente_empresa = vehiculo.cliente.empresa.nombre if vehiculo.cliente and vehiculo.cliente.empresa else "SIN EMPRESA"
            print(f"Vehículo: {vehiculo.patente} - Empresa: {empresa_nombre} - Cliente Empresa: {cliente_empresa}")
