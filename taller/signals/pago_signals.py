...
def notificar_pago_nuevo(sender, instance, created, **kwargs):
    ...
    try:
        ...
        admin_email = getattr(settings, "ADMIN_EMAIL", None) or get_support_reply_to()
...
def registrar_email_confirmado_embudo(sender, instance, **kwargs):
    ...
    if instance.verified:
        try:
            from taller.reportes.services.registro_embudo_service import registrar_email_confirmado
