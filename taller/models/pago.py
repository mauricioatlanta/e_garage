...
class PagoPendiente(models.Model):
    ...
    empresa = models.ForeignKey('taller.Empresa', on_delete=models.CASCADE, related_name='pagos_pendientes')
    ...
    verificado_por = models.ForeignKey('auth.User', on_delete=models.SET_NULL, null=True, blank=True, related_name='pagos_verificados')
    
    notas = models.TextField(blank=True, help_text='Notas del administrador')
    
    # Datos adicionales del pago
    referencia = models.CharField(max_length=100, blank=True)
    metodo_pago = models.CharField(max_length=50, default='transferencia')  # transferencia, paypal, stripe
