...
try:
    ...
    urlpatterns = [
        ...
        path(
            "vehiculos/<int:pk>/crear-venta-desde-inventario/",
            crear_venta_desde_inventario,
            name="crear_venta_desde_inventario",
        ),
        path(
            "vehiculos/<int:pk>/confirmar-venta-desde-inventario/",
            confirmar_venta_desde_inventario,
            name="confirmar_venta_desde_inventario",
        ),
        path(
            "vehiculos/<int:pk>/finalizar-venta-desde-inventario/",
            finalizar_venta_desde_inventario,
            name="finalizar_venta_desde_inventario",
        ),
        path(
            "api/piezas/<int:pk>/estado/",
            views.api_pieza_actualizar_estado,
            name="api_pieza_estado",
        ),
        path(
            "api/piezas/<int:pk>/precio/",
            views.api_pieza_actualizar_precio,
            name="api_pieza_precio",
        ),
        path(
            "api/piezas/<int:pk>/label-empresa/",
            views.api_pieza_label_empresa_guardar,
            name="api_pieza_label_empresa_guardar",
        ),
        path(
            "api/piezas/bulk-estado/", views.api_piezas_bulk_estado, name="api_piezas_bulk_estado"
        ),
        path(
