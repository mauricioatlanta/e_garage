#!/usr/bin/env python
"""
Script que consulta directamente la base de datos sin usar Django setup.
Evita el problema de configuración con allauth.
"""
        ...
        for pais_codigo in paises:
            ...
            if empresas:
                for idx, emp in enumerate(empresas, 1):
                    ...
                    print(
                        f"     Nombre: {(emp['first_name'] or '')} {(emp['last_name'] or '')}".strip()
                        or "N/A"
                    )
