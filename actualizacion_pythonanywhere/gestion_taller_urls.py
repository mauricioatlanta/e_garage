...
urlpatterns = [
    ...
    path(
        "landing-bilingue/",
        TemplateView.as_view(template_name="public/landing_inicio_en.html"),
        name="landing_bilingue",
    ),
    ...
    path(
        "bienvenida/usa/",
        TemplateView.as_view(template_name="onboarding/bienvenida_usa.html"),
        name="bienvenida_usa",
    ),
    path(
        "welcome/us/",
    ...
    path(
        "egarage-pro/", landing_egarage, name="landing_egarage_pro"
    ),  # Alternativa en /egarage-pro/
    ...
    path(
        "api/",
        include(
            ("taller.servicios.urls_servicios", "servicios_api"),
            namespace="servicios_api",
        ),
    ),
]
