...
def debug_documento_f882():
    ...
    try:
        ...
        print(
            f"   Empresa: {documento.empresa.nombre_taller if documento.empresa else 'Sin empresa'}"
        )
        ...
        if servicios.exists():
            for serv in servicios:
                ...
                print(
                    f"     Empresa: {serv.empresa.nombre_taller if serv.empresa else 'Sin empresa'}"
                )
        else:
        ...
        for doc in documentos_factura:
            ...
            print(
                f"   - {doc.numero_documento}: {repuestos_count} repuestos, {servicios_count} servicios"
            )
