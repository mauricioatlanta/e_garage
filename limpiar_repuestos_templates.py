...
ARCHIVE_ROOT = BASE_DIR / "templates" / "_archive" / "20251123_repuestos_cleanup"

# Directorios de repuestos que ya no encajan con la nueva estructura por país
PATTERNS = [
    "templates/taller/repuestos",  # módulo genérico viejo
    "templates/taller/cl/es/repuestos",  # carpeta vacía, versión antigua Chile
]
...
def main(dry_run: bool = True):
    print("=== Limpieza módulo REPUESTOS ===")
