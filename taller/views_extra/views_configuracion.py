...
def configuracion_empresa(request):
    ...
    🔒 SOLO el Owner puede cambiar la configuración de la empresa
    (logo, RUT, nombre del taller, etc.).
    Un vendedor o técnico no debe poder cambiar estos datos sensibles.
    """
