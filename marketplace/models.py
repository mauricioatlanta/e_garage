...
class CasaRepuestos(TenantScoped):
    ...
    """
    nombre = models.CharField(max_length=200, db_index=True, help_text="Nombre de la casa de repuestos")
    contacto = models.CharField(max_length=200, blank=True, null=True, help_text="Contacto o persona responsable")
...
class ProductoCatalogo(TenantScoped):
    ...
    activo = models.BooleanField(
        default=True,
        help_text="Si el producto está disponible en el catálogo"
    )
    ...
    ultima_actualizacion_precio = models.DateTimeField(
        auto_now=True,
        help_text="Última vez que se actualizó el precio"
    )
