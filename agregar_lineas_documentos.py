...
def agregar_lineas_documentos():
    ...
    if not documentos:
        print("❌ No hay documentos en el sistema. Ejecuta primero crear_datos_prueba_i18n_simple.py")
        return
    ...
    for doc in documentos:
        ...
        if doc.lineas_repuesto.exists() or doc.lineas_servicio.exists():
            print(f"   ⚠️ Documento ya tiene líneas, saltando...")
            continue
        ...
        print(f"   🏢 Agregando servicio externo...")
        if empresa.pais == 'CL':
