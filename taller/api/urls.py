...
urlpatterns = [
    ...
    path('vehiculos/<int:cliente_id>/', views.vehiculos_cliente_api, name='vehiculos_cliente_api'),
    ...
    path('otros-servicios/', views.buscar_otros_servicios_api, name='buscar_otros_servicios_api'),
