"""
Modelos del módulo documentos

Este módulo contiene modelos relacionados con documentos:
- DetalleDocumento: Líneas de items en documentos
- DocumentSequence: Secuencias de numeración por tipo de documento
- LineaDocumento: Modelo legacy de líneas (puede no estar en uso)

Nota: El modelo principal Documento está en taller.models.documento
"""
...
# Importar modelos sueltos para que Django los registre
