...
urlpatterns = [
    ...
    path(
        "clientes/<int:cliente_id>/verificar-facturacion/",
        views.api_verificar_facturacion_cliente,
        name="verificar_facturacion_cliente",
    ),
    path(
        "clientes/<int:cliente_id>/completar-facturacion/",
        views.api_completar_datos_facturacion,
        name="completar_facturacion_cliente",
    ),
    path(
    ...
    path("piezas-desarme/", views.buscar_piezas_desarme_api, name="buscar_piezas_desarme_api"),
    ...
    path(
        "vehiculos/procesar-foto-patente/",
        views.api_procesar_foto_patente,
        name="procesar_foto_patente",
    ),
]
