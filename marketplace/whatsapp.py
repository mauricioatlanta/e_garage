...
class WhatsAppGateway:
    ...
    def enviar_mensaje_cliente(
        self, telefono: str, documento: Documento, link_ver_detalle: str
    ) -> Dict[str, Any]:
        """
    ...
    def enviar_mensaje_proveedor(
        self, telefono: str, documento: Documento, part_number: str, link_confirmar_stock: str
    ) -> Dict[str, Any]:
        """
        ...
        """
        mensaje = self._generar_mensaje_proveedor(documento, part_number, link_confirmar_stock)
    ...
    def _generar_mensaje_proveedor(self, documento: Documento, part_number: str, link: str) -> str:
    ...
    def _enviar_ultramsg(self, telefono: str, mensaje: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "provider": "ultramsg", "error": str(e)}
    ...
    def _enviar_twilio(self, telefono: str, mensaje: str) -> Dict[str, Any]:
        ...
        try:
            ...
            message = client.messages.create(
                body=mensaje, from_=whatsapp_from, to=f"whatsapp:{telefono_formateado}"
            )
            return {
                "success": True,
                "provider": "twilio",
