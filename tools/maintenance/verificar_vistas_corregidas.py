...
def verificar_vistas_corregidas():
    ...
    try:
        ...
        if documento:
            print(f"✅ Consulta optimizada exitosa")
            ...
            print(f"   🔧 Técnico: {documento.tecnico_responsable.nombre if documento.tecnico_responsable else 'Sin técnico'}")
            ...
            print(f"❌ No hay documentos en la base de datos")
            return False
