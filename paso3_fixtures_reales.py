...
class FixturesRealesGenerator:
    ...
    def crear_servicios_caracteristicos_chile(self):
        ...
        categorias_cl = [
            {'code': 'demo_mantencion_cl', 'nombre_es': 'Mantención Preventiva', 'nombre_en': 'Preventive Maintenance'},
            {'code': 'demo_reparacion_cl', 'nombre_es': 'Reparaciones Generales', 'nombre_en': 'General Repairs'},
            {'code': 'demo_revision_cl', 'nombre_es': 'Revisión Técnica', 'nombre_en': 'Technical Inspection'},
            {'code': 'demo_emergencia_cl', 'nombre_es': 'Servicios de Emergencia', 'nombre_en': 'Emergency Services'}
        ]
        ...
        servicios_cl = [
            # Mantención
            {'cat': 'demo_mantencion_cl', 'code': 'demo_cambio_aceite_cl', 'tipo': 'interno', 
             'nombre_es': 'Cambio de aceite y filtros', 'nombre_en': 'Oil and filter change',
             'precio': 25000, 'aliases_es': ['cambio aceite', 'mantención básica'], 'aliases_en': ['oil change', 'basic maintenance']},
            
            {'cat': 'demo_mantencion_cl', 'code': 'demo_alineacion_cl', 'tipo': 'interno',
             'nombre_es': 'Alineación y balanceado', 'nombre_en': 'Wheel alignment and balancing', 
             'precio': 35000, 'aliases_es': ['alineación', 'balanceado'], 'aliases_en': ['alignment', 'balancing']},
            
            # Reparaciones
            {'cat': 'demo_reparacion_cl', 'code': 'demo_frenos_cl', 'tipo': 'interno',
             'nombre_es': 'Reparación sistema de frenos', 'nombre_en': 'Brake system repair',
             'precio': 80000, 'aliases_es': ['frenos', 'pastillas'], 'aliases_en': ['brakes', 'brake pads']},
            
            {'cat': 'demo_reparacion_cl', 'code': 'demo_suspension_cl', 'tipo': 'interno',
             'nombre_es': 'Reparación suspensión', 'nombre_en': 'Suspension repair',
             'precio': 120000, 'aliases_es': ['suspensión', 'amortiguadores'], 'aliases_en': ['suspension', 'shock absorbers']},
            
            # Revisión técnica
            {'cat': 'demo_revision_cl', 'code': 'demo_revision_tecnica_cl', 'tipo': 'interno',
             'nombre_es': 'Revisión técnica vehicular', 'nombre_en': 'Vehicle technical inspection',
             'precio': 15000, 'aliases_es': ['revisión técnica', 'rt'], 'aliases_en': ['technical inspection', 'vehicle inspection']},
            
            # Servicios externos (subcontratados)
            {'cat': 'demo_emergencia_cl', 'code': 'demo_grua_cl', 'tipo': 'externo',
             'nombre_es': 'Servicio de grúa', 'nombre_en': 'Towing service',
             'precio': 50000, 'aliases_es': ['grúa', 'remolque'], 'aliases_en': ['towing', 'tow truck']},
            
            {'cat': 'demo_emergencia_cl', 'code': 'demo_auxilio_cl', 'tipo': 'externo',
             'nombre_es': 'Auxilio mecánico en ruta', 'nombre_en': 'Roadside assistance',
             'precio': 30000, 'aliases_es': ['auxilio', 'mecánico en ruta'], 'aliases_en': ['roadside assistance', 'emergency service']}
        ]
    ...
    def crear_servicios_caracteristicos_usa(self):
        ...
        categorias_us = [
            {'code': 'demo_maintenance_us', 'nombre_es': 'Mantenimiento', 'nombre_en': 'Maintenance'},
            {'code': 'demo_repair_us', 'nombre_es': 'Reparaciones', 'nombre_en': 'Repairs'},
            {'code': 'demo_inspection_us', 'nombre_es': 'Inspecciones', 'nombre_en': 'Inspections'},
            {'code': 'demo_emergency_us', 'nombre_es': 'Emergencias', 'nombre_en': 'Emergency Services'}
        ]
        ...
        servicios_us = [
            # Maintenance
            {'cat': 'demo_maintenance_us', 'code': 'demo_oil_change_us', 'tipo': 'interno',
             'nombre_es': 'Cambio de aceite', 'nombre_en': 'Oil Change Service',
             'precio': 45.99, 'aliases_es': ['aceite'], 'aliases_en': ['oil change', 'lube service']},
            
            {'cat': 'demo_maintenance_us', 'code': 'demo_tire_rotation_us', 'tipo': 'interno',
             'nombre_es': 'Rotación de neumáticos', 'nombre_en': 'Tire Rotation',
             'precio': 25.99, 'aliases_es': ['neumáticos', 'rotación'], 'aliases_en': ['tire rotation', 'wheel rotation']},
            
            # Repairs
            {'cat': 'demo_repair_us', 'code': 'demo_brake_service_us', 'tipo': 'interno',
             'nombre_es': 'Servicio de frenos', 'nombre_en': 'Brake Service',
             'precio': 189.99, 'aliases_es': ['frenos'], 'aliases_en': ['brake service', 'brake repair']},
            
            {'cat': 'demo_repair_us', 'code': 'demo_transmission_us', 'tipo': 'interno',
             'nombre_es': 'Servicio transmisión', 'nombre_en': 'Transmission Service',
             'precio': 299.99, 'aliases_es': ['transmisión'], 'aliases_en': ['transmission', 'trans service']},
            
            # Inspections
            {'cat': 'demo_inspection_us', 'code': 'demo_state_inspection_us', 'tipo': 'interno',
             'nombre_es': 'Inspección estatal', 'nombre_en': 'State Inspection',
             'precio': 18.99, 'aliases_es': ['inspección'], 'aliases_en': ['state inspection', 'vehicle inspection']},
            
            # External services
            {'cat': 'demo_emergency_us', 'code': 'demo_towing_us', 'tipo': 'externo',
             'nombre_es': 'Servicio de remolque', 'nombre_en': 'Towing Service',
             'precio': 125.00, 'aliases_es': ['remolque', 'grúa'], 'aliases_en': ['towing', 'tow service']},
            
            {'cat': 'demo_emergency_us', 'code': 'demo_roadside_us', 'tipo': 'externo',
             'nombre_es': 'Asistencia en carretera', 'nombre_en': 'Roadside Assistance',
             'precio': 89.99, 'aliases_es': ['asistencia'], 'aliases_en': ['roadside assistance', 'emergency help']}
        ]
    ...
    def crear_marcas_modelos_vehiculos(self):
        ...
        colores = ['Blanco', 'Negro', 'Gris', 'Azul', 'Rojo', 'Verde', 'Amarillo', 'Plata']
        ...
        for marca_nombre, modelos in marcas_modelos_cl.items():
            ...
            for modelo_nombre in modelos:
                modelo = Modelo.objects.filter(marca=marca, nombre=modelo_nombre, country='CL').first()
                if not modelo:
        ...
        for marca_nombre, modelos in marcas_modelos_us.items():
            ...
            # Crear modelos para esta marca
            for modelo_nombre in modelos:
                modelo = Modelo.objects.filter(marca=marca, nombre=modelo_nombre, country='US').first()
                if not modelo:
                    modelo = Modelo.objects.create(
                        marca=marca,
                        nombre=modelo_nombre,
    ...
    def crear_clientes_y_vehiculos_chile(self):
        ...
        clientes_cl = [
            {'nombre': 'Juan Carlos', 'apellido': 'Pérez González', 'telefono': '+56 9 8765 4321', 
             'email': 'jperez@email.cl', 'vehiculos': [
                {'marca': 'Toyota', 'modelo': 'Corolla', 'año': 2019, 'patente': 'ABCD12'},
                {'marca': 'Chevrolet', 'modelo': 'Spark', 'año': 2020, 'patente': 'EFGH34'}
             ]},
            {'nombre': 'María Elena', 'apellido': 'Silva Rodríguez', 'telefono': '+56 9 7654 3210',
             'email': 'msilva@gmail.com', 'vehiculos': [
                {'marca': 'Hyundai', 'modelo': 'Accent', 'año': 2018, 'patente': 'IJKL56'}
             ]},
            {'nombre': 'Carlos Alberto', 'apellido': 'Morales Castro', 'telefono': '+56 9 6543 2109',
             'email': 'cmorales@outlook.cl', 'vehiculos': [
                {'marca': 'Nissan', 'modelo': 'Sentra', 'año': 2021, 'patente': 'MNOP78'},
                {'marca': 'Kia', 'modelo': 'Rio', 'año': 2017, 'patente': 'QRST90'}
             ]},
            {'nombre': 'Andrea', 'apellido': 'Fernández López', 'telefono': '+56 9 5432 1098',
             'email': 'afernandez@empresa.cl', 'vehiculos': [
                {'marca': 'Suzuki', 'modelo': 'Swift', 'año': 2019, 'patente': 'UVWX12'}
             ]},
            {'nombre': 'Roberto', 'apellido': 'Muñoz Henríquez', 'telefono': '+56 9 4321 0987',
             'email': 'rmunoz@hotmail.com', 'vehiculos': [
                {'marca': 'Ford', 'modelo': 'Fiesta', 'año': 2020, 'patente': 'YZAB34'},
                {'marca': 'Peugeot', 'modelo': '208', 'año': 2018, 'patente': 'CDEF56'}
             ]}
        ]
        ...
        for empresa in empresas_cl:
            for cliente_data in clientes_cl:
                ...
                for vehiculo_data in cliente_data['vehiculos']:
                    ...
                    marca = Marca.objects.filter(nombre=vehiculo_data['marca'], country='CL').first()
                    modelo = Modelo.objects.filter(marca=marca, nombre=vehiculo_data['modelo'], country='CL').first()
                    color = ColorVehiculo.objects.filter(nombre__in=['Blanco', 'Negro', 'Gris', 'Azul', 'Rojo']).order_by('?').first()
                ...
                print(f"   ✅ {cliente.nombre} {cliente.apellido} ({len(cliente_data['vehiculos'])} vehículos)")
    ...
    def crear_clientes_y_vehiculos_usa(self):
        ...
        clientes_us = [
            {'nombre': 'Michael', 'apellido': 'Johnson', 'telefono': '+1 305 555 1234',
             'email': 'mjohnson@email.com', 'vehiculos': [
                {'marca': 'Ford', 'modelo': 'F-150', 'año': 2020, 'patente': 'ABC123'},
                {'marca': 'Honda', 'modelo': 'Civic', 'año': 2019, 'patente': 'DEF456'}
             ]},
            {'nombre': 'Sarah', 'apellido': 'Williams', 'telefono': '+1 323 555 5678',
             'email': 'swilliams@gmail.com', 'vehiculos': [
                {'marca': 'Toyota', 'modelo': 'Camry', 'año': 2021, 'patente': 'GHI789'}
             ]},
            {'nombre': 'David', 'apellido': 'Brown', 'telefono': '+1 214 555 9012',
             'email': 'dbrown@company.com', 'vehiculos': [
                {'marca': 'Chevrolet', 'modelo': 'Silverado', 'año': 2018, 'patente': 'JKL012'},
                {'marca': 'Nissan', 'modelo': 'Altima', 'año': 2020, 'patente': 'MNO345'}
             ]},
            {'nombre': 'Jennifer', 'apellido': 'Davis', 'telefono': '+1 305 555 3456',
             'email': 'jdavis@outlook.com', 'vehiculos': [
                {'marca': 'Hyundai', 'modelo': 'Elantra', 'año': 2019, 'patente': 'PQR678'}
             ]},
            {'nombre': 'Robert', 'apellido': 'Miller', 'telefono': '+1 323 555 7890',
             'email': 'rmiller@hotmail.com', 'vehiculos': [
                {'marca': 'BMW', 'modelo': '320i', 'año': 2020, 'patente': 'STU901'},
                {'marca': 'Mercedes', 'modelo': 'C-Class', 'año': 2018, 'patente': 'VWX234'}
             ]}
        ]
        ...
        for empresa in empresas_us:
            for cliente_data in clientes_us:
                ...
                for vehiculo_data in cliente_data['vehiculos']:
                    ...
                    marca = Marca.objects.filter(nombre=vehiculo_data['marca'], country='US').first()
                    modelo = Modelo.objects.filter(marca=marca, nombre=vehiculo_data['modelo'], country='US').first()
                    color = ColorVehiculo.objects.filter(nombre__in=['Blanco', 'Negro', 'Gris', 'Azul', 'Rojo']).order_by('?').first()
                ...
                print(f"   ✅ {cliente.nombre} {cliente.apellido} ({len(cliente_data['vehiculos'])} vehicles)")
