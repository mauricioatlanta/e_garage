...
class Command(BaseCommand):
    ...
    def limpiar_datos_demo(self):
        ...
        self.stdout.write(self.style.WARNING("⚠️ Datos demo limpiados"))
        ...
        servicios_atlanta = [
            {
                ...
                "servicios": [
                    ...
                    {
                        "nombre": "Tire Rotation & Balance",
                        "precio": 35.00,
                        "tiempo": 45,
                    },
                    {"nombre": "Air Filter Replacement", "precio": 25.00, "tiempo": 15},
                    {
                        "nombre": "Cabin Filter Replacement",
                        "precio": 30.00,
                        "tiempo": 20,
                    },
                ],
            ...
            },
            {
                ...
                "servicios": [
                    ...
                    {
                        "nombre": "A/C Refrigerant Recharge",
                        "precio": 65.00,
                        "tiempo": 45,
                    },
                    {
                        "nombre": "A/C Compressor Replacement",
                        "precio": 285.00,
                        "tiempo": 180,
                    },
            ...
            },
            {
                ...
                "servicios": [
                    ...
                    {
                        "nombre": "Transmission Fluid Change",
                        "precio": 85.00,
                        "tiempo": 45,
                    },
                    {
                        "nombre": "Transmission Diagnostic",
                        "precio": 125.00,
                        "tiempo": 90,
                    },
