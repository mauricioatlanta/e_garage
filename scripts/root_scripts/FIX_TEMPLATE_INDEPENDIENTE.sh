#!/bin/bash
# Script para hacer el template completamente independiente y aislado
...
echo "📋 Creando backup..."
cp "$FILE" "$FILE.backup_independiente_$(date +%Y%m%d_%H%M%S)"

echo "🔧 Haciendo template completamente independiente..."
...
<head>
  ...
  <style>
    /* Reset completo para aislar de CSS global */
    * {
      margin: 0;
      padding: 0;
...
echo "✅ Template hecho completamente independiente"
