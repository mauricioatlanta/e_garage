...
def agregar_required_campos():
    ...
    for campo in campos_requeridos:
        ...
        content = re.sub(patron_input, agregar_required_input, content, flags=re.MULTILINE | re.DOTALL)
        content = re.sub(patron_select, agregar_required_select, content, flags=re.MULTILINE | re.DOTALL)
